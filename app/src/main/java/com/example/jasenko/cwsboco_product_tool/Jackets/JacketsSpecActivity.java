...
public class JacketsSpecActivity extends AppCompatActivity {
    ...
    public static SpinnerDetails[] spinners = new SpinnerDetails[8];   //[0] = productType, [1] = collar, [2] = cuffs, [3] = pockets, [4] = stud, [5] = fabric, [6] = garmentColor, [7] = collarColor;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jackets_spec);
    ...
    private void addSpinnerProductType()
    {
        ...
        spinners[0] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_product_type_jacket), "");
    ...
    private void addSpinnerCollar()
    {
        ...
        spinners[1] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_collar_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerCuffs()
    {
        ...
        spinners[2] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_cuffs_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerPockets()
    {
        ...
        spinners[3] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_pockets_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerStud()
    {
        ...
        spinners[4] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_stud), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerFabric()
    {
        ...
        spinners[5] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_fabric_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerGarmentColor()
    {
        ...
        spinners[6] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_garmentColor_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    private void addSpinnerCollarColor()
    {
        ...
        spinners[7] = new SpinnerDetails((Spinner) findViewById(R.id.spinner_collarColor_jacket), "");
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_layout, R.id.txt, entries);
    ...
    {
        Button aContinue = (Button) findViewById(R.id.continue_button_spec_jacket);
    ...
    private void addListenerOnSpinnerItemSelection6(final Spinner spinner) {
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(!spinners[5].getSpinnerName().equals("Select fabric...")) {
    ...
    private void addListenerOnSpinnerItemSelection8(final Spinner spinner) {
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(!spinners[7].getSpinnerName().equals("Select collar color...")) {
                    colorSpinners = true;
                }
            }
            @Override
